...
Feature: Statistics of payments
  ...
  Scenario: There are not payments done
  	...
  	And I fill in "stats[from_date]" with "2010/01/01"
    And I fill in "stats[to_date]" with "2010/05/01"
  ...
  Scenario: There are payments done in given period
	...
	And there is payment_done with name "Gasto-test1" and date "2010/04/30" and amount "100"
	And there is payment_done with name "Gasto-test2" and date "2010/02/30" and amount "50"
  ...
  Scenario: There are not payments done in given period
	...
	And there is payment_done with name "Gasto-test2" and date "2011/02/30" and amount "50"
