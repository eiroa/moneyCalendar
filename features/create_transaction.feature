...
Feature: Create new Payment
  ...
  Scenario: Happy Path to Payment
    ...
    And I press "addNewPaymentButton"
  ...
  Scenario: Happy Path to Income
    Given I am on "coming expirations page"
    And I press "addNewIncomeButton"
  ...
  Scenario: Happy Path to Single Income
    Given I am on "coming expirations page"
    And I press "addNewIncomeButton"
    And I fill in "name" with "Ingreso-test"
    And I fill in "amount" with "1000"
    And I fill in "date" with "2020/1/1"
    And I select "Single Income" from "periodicity"  
    When I press "saveButton"
    Then I should see "The Ingreso-test income has been registered"
  ...
  Scenario: Income Date is set earlier than actual date
    Given I am on "coming expirations page"
    And I press "addNewIncomeButton"
    And I fill in "name" with "Gasto-test"
    And I select "1 Month" from "periodicity"
 ...
 Scenario: IncomeDone already exists
    Given I am on "coming expirations page"
    And I press "addNewIncomeButton"
    And I fill in "name" with "Ingreso-test"
    And I fill in "amount" with "1000"
